...
const DEFAULTS: Config = {
  api:    { app_id: '', token: '' },
  tts:    { voice: 'zh_female_tianmei', model: 'seed-tts-1.1',
            speed: 0, volume: 0, sample_rate: 24000,
            bit_rate: 128000, format: 'mp3', lang: 'zh-cn' },
...
export async function runSetup(): Promise<void> {
  ...
  saveConfig({ ...DEFAULTS, api: { app_id, token }, tts: { ...DEFAULTS.tts, voice } })
